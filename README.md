...
Check out [this page](https://andersenlab.org/dry-guide/latest/pipelines/adding-seq-data/) for instructions on how to do that. Once done, you should be able to view your NILs on the [NIL browser shiny app](https://andersen-lab.shinyapps.io/nil-browser/).
